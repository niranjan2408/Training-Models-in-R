...
rect.hclust(hierarchical_clustering,k=5)

passenger_class<-cutree(hierarchical_clustering,k=5)

passenger_class<-as.matrix(passenger_class)

Airlines_passenger_class<-data.frame(Airlines,passenger_class)

Airlines_passenger_class_Final<-Airlines_membership[,c(ncol(Airlines_membership),1:(ncol(Airlines_membership)-1))]

write.xlsx(Airlines_passenger_class_Final,file = "Airlines_passenger_class_hierarchical_clustering_Final.xlsx")
